...
vmod0 = dj.create_virtual_module('vmod0', 'u19_subject')
vmod1 = dj.create_virtual_module('vmod1', 'u19_lab')
vmod2 = dj.create_virtual_module('vmod2', 'u19_task')


@schema
class SessionStartedOld(dj.Manual):
    definition = """
    ...
    -> vmod1.Location.proj(session_location="location")
